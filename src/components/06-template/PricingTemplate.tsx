            ...
            <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black/5">
              ...
              <div className="space-y-6 py-6 px-5">
                ...
                <div className="space-y-6">
                  <a
                    href="#"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-primary-600 py-2 px-4 text-base font-medium text-white hover:bg-primary-700"
                  >
                    Sign up
                  </a>
          ...
          <div className="space-y-4 border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between lg:space-y-0 xl:mt-0">
            ...
            <form className="sm:flex sm:max-w-md">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-full min-w-0 rounded-md border border-transparent bg-white py-2 px-4 placeholder:text-gray-500 focus:border-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 sm:max-w-xs"
