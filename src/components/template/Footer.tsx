...
import { FooterCompanyInfo } from '../04-lib/footer/FooterCompanyInfo';
import { FooterLinks } from '../04-lib/footer/FooterLinks';
import { FooterTwoRowsCopyright } from '../04-lib/footer/FooterTwoRowsCopyright';
