                    ...
                    <div className="w-full max-w-lg lg:max-w-xs">
                      ...
                      <div className="relative text-sky-100 focus-within:text-gray-400">
                        ...
                        <input
                          id="search"
                          name="search"
                          className="block w-full rounded-md border border-transparent bg-sky-700/50 py-2 pl-10 pr-3 leading-5 placeholder:text-sky-100 focus:border-white focus:bg-white focus:text-gray-900 focus:outline-none focus:ring-white focus:placeholder:text-gray-500 sm:text-sm"
                          placeholder="Search"
                          type="search"
                        />
                      </div>
